<!--Vista asociada a la revision de Secpla para las fichas de Gastos Corrientes-->
<?php
session_start();
...
$sql = "SELECT * FROM caja_comentarios_secpla WHERE id_ficha_GC = $iden_FGC";
...
<body>
  <div class="container">
    ...
    <div class="right-column">
      <table class="table table-striped table-dark">
        ...
        <tr>
          <td><?php echo $comentarios['fecha_comentario'] ?></td>
  ...
  <div class="button-container">
    <a href="../../Secpla/secpla_revision/secpla_gastos_corrientes.php"><button class="btn btn-dark">Regresar</button></a>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="../../controladores/controlador_secpla/secpla_aceptar_ficha.php" method="POST">
            <input type="text" name="ficha_acept_secpla" value="<?php echo $iden_FGC ?>">
            <div class="form-group">
              <label>Fecha</label>
              <input type="date" name="fecha_secpla_aceptar" value="<?php echo date('Y-m-d') ?>" class="form-control" readonly>
            </div>
            <div class="form-group">
              <label for="observaciones">Observaciones:</label>
              <textarea type="text" class="form-control" id="observaciones" name="observaciones_secpla_aceptar"></textarea>
            </div>
            <button type="submit" name="ficha_aceptar_secpla" class="btn btn-success">Aceptar</button>
          </form>
        </div>
      </div>
    </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="../../controladores/controlador_secpla/secpla_rechazar_ficha.php" method="POST">
            <input type="text" name="ficha_rechazar_secpla_id" value="<?php echo $iden_FGC ?>">
            <div class="form-group">
              <label>Fecha</label>
              <input type="date" name="fecha_secpla_rechazar" value="<?php echo date('Y-m-d') ?>" class="form-control" readonly>
            </div>
            <div class="form-group">
              <label>Monto Recomendado SECPLA</label>
              <input type="number" name="monto_secpla_rechazar" value="" class="form-control" required>
            </div>
            <div class="form-group">
              <label>Clasificar Presupuesto</label>
              <br>
              <select name="clasi_GC_rechazar" class="form-control" required>
                <option value="<?php echo $datos_FGC['id_cla_presupuestario']?>"> <?php echo $datos_FGC['nombre_cuenta']?> </option>
                <?php
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" id="motivo" name="observaciones_secpla_rechazar" name="observaciones_director_rechazar"></textarea>
            </div>
            <button type="submit" name="ficha_rechazar_secpla" class="btn btn-danger">Rechazar</button>
          </form>
        </div>
      </div>
</body>
