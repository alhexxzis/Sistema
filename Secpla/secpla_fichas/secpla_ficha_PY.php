      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="../../controladores/controlador_secpla/secpla_aceptar_ficha.php" method="POST">
            <input type="text" name="ficha_acept_secpla_PY" value="<?php echo $iden_PY ?>">
            <div class="form-group">
              <label>Fecha</label>
              <input type="date" name="fecha_secpla_aceptar_PY" value="<?php echo date('Y-m-d') ?>" class="form-control" readonly>
            </div>
            <div class="form-group">
              <label for="observaciones">Observaciones:</label>
              <textarea type="text" class="form-control" id="observaciones" name="observaciones_secpla_aceptar_PY"></textarea>
            </div>
            <button type="submit" name="ficha_aceptar_secpla_PY" class="btn btn-success">Aceptar</button>
          </form>
        </div>
      </div>
    </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="../../controladores/controlador_secpla/secpla_rechazar_ficha.php" method="POST">
            <input type="text" name="rechazar_secpla_PY" value="<?php echo $iden_PY ?>">
            <div class="form-group">
              <label>Fecha</label>
              <input type="date" name="fecha_secpla_rechazar_PY" value="<?php echo date('Y-m-d') ?>" class="form-control" readonly>
            </div>
            <div class="form-group">
              <label>Monto Recomendado SECPLA</label>
              <input type="number" name="monto_secpla_rechazar_PY" value="" class="form-control" required>
            </div>
            <div class="form-group">
              <label>Clasificar Presupuesto</label>
              <br>
              <select name="clasi_PY_rechazar" class="form-control" required>
                <option value="<?php echo $datos_PY['id_cla_presupuestario']?>"> <?php echo $datos_PY['nombre_cuenta']?> </option>
                <?php
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" id="motivo" name="observaciones_secpla_rechazar_PY"></textarea>
            </div>
            <button type="submit" name="ficha_rechazar_secpla_PY" class="btn btn-danger">Rechazar</button>
          </form>
        </div>
      </div>
</body>
