  ...
  <div class="container">
    ...
    <table class="table table-bordered table-hover table-dark">
      ...
      <?php
        ...
        WHERE ficha_proyectos.estado_ficha_PY = 5";
        $mostrar = mysqli_query($conexion1, $sql2);
        while ($resultado = mysqli_fetch_array($mostrar)) {
        ?>
          <tr>
            <td scope="row"><?php echo $resultado['id_PY'] ?></td>
            <td scope="row"><?php echo $resultado['nombre_ficha_PY'] ?></td>
            <td scope="row"><?php echo $resultado['desc_tipo_ficha'] ?></td>
            <td scope="row"><?php echo $resultado['fecha_PY'] ?></td>
            <td scope="row"><?php echo $resultado['desc_direccion'] ?></td>
            <td scope="row"><?php echo $resultado['total_PY'] ?></td>
            <td scope="row"><?php echo $resultado['nombre'] ?> <?php echo $resultado['apellido'] ?></td>
            <td scope="row"><?php echo $resultado['prioridades'] ?></td>
            <td><a href="../../Secpla/secpla_fichas/secpla_ficha_PY.php?id_PY=<?php echo $resultado['id_PY'] ?>" 
